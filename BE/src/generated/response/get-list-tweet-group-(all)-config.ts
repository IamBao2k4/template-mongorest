export const GET_LIST_TWEET_GROUP_(ALL) = {
...
`,
  ...
  data: {
  "id": "a626d341-c344-48bd-ba6e-6c1690c61456",
  "rules": [],
  "combinator": "and",
  "not": false
},
  ...
  id: "676524ca6e57acaf6815af33",
} as const;

export type GetListTweetGroupAllConfig = typeof GET_LIST_TWEET_GROUP_(ALL);