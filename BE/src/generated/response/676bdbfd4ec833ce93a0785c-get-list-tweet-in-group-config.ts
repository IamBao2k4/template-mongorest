export const GET_LIST_TWEET_IN_GROUP = {
          ...
          },
          {
            "$cond": {
              ...
              "then": {
                "$or": [
                  {
                    "$in": ["$categories", ["@param:categories[]"]]
                  },
                  {
                    "$in": ["$categories", [["@param:categories[]"]]]
                  }
...
`,
  ...
  id: "676bdbfd4ec833ce93a0785c",
} as const;

export type GetListTweetInGroupConfig = typeof GET_LIST_TWEET_IN_GROUP;