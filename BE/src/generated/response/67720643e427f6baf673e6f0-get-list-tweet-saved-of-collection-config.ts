export const GET_LIST_TWEET_SAVED_OF_COLLECTION = {
      ...
      "pipeline": [
        {
          "$match": {
            ...
            "user_collection": "@param:collection_id"
          }
        }
      ],
      "as": "saved_info"
...
`,
  ...
  id: "67720643e427f6baf673e6f0",
} as const;

export type GetListTweetSavedOfCollectionConfig = typeof GET_LIST_TWEET_SAVED_OF_COLLECTION;