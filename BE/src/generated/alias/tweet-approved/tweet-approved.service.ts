...
export class TweetApprovedService {
    ...
    "validate": [
      {
        "notification": {
          ...
          "path_file": "json/notification/67da2d7fff9b2c7f1959f3d3.json"
        },
        "response": {
          "_id": "67d94874ff9b2c7f19597fac",
          "title": "approve tweet news",
          "entity": "mge-tweet-social-news",
          "path_file": "json/response/67d94874ff9b2c7f19597fac.json"
        },
        "query_validate": {
          "combinator": "and",
          "rules": [
            {
              "id": "5436bdd6-6819-413b-a27d-5cafe88222c9",
              "field": "data",
              "operator": "=",
              "valueSource": "value",
            ...
            {
              "id": "2b4aaf61-3fb0-420a-a481-db0fc82bd799",
              "field": "data",
              "operator": "=",
              "valueSource": "value",
              "value": "67da3303ff9b2c7f1959f964"
            },
            {
              "id": "5870f1da-ae62-470e-a78f-a4fce3fb54e2",
              "field": "data",
              "operator": "=",
              "valueSource": "value",
            ...
            {
              "id": "ab5021c7-0d76-4bda-ae5a-2cf5a8849564",
              "field": "data",
              "operator": "=",
              "valueSource": "value",
            ...
            {
              "id": "3759f215-77ad-4680-ba96-36d5c1653718",
              "field": "data",
              "operator": "=",
              "valueSource": "value",
              "value": "67725d57e240a7d43f0efa23"
            }
          ],
          "id": "0bfeca4e-7607-4c69-a218-ec495d07abfd"
        },
        "list_validate": [
          {
          ...
          },
          {
            ...
            "path_file": "json/validate/67725d57e240a7d43f0efa23.json"
          },
          {
          ...
          },
          {
            ...
            "path_file": "json/validate/67da3303ff9b2c7f1959f964.json"
          }
        ],
        "custom_filter": {
          "rules": []
      ...
      },
      {
        ...
        "response": {
          "_id": "67da2874ff9b2c7f1959f016",
          "title": "approve tweet image",
          "entity": "mge-tweet-social-image",
          "path_file": "json/response/67da2874ff9b2c7f1959f016.json"
        },
        "query_validate": {
          "combinator": "and",
          "rules": [
            ...
            {
              "id": "6c5dbaa7-cce8-40ba-86d9-56234308413b",
              "field": "data",
              "operator": "=",
              "valueSource": "value",
              "value": "67da3303ff9b2c7f1959f964"
      ...
      },
      {
        ...
        "response": {
          "_id": "67da28beff9b2c7f1959f07e",
          "title": "approve tweet video",
          "entity": "mge-tweet-social-videos",
          "path_file": "json/response/67da28beff9b2c7f1959f07e.json"
        },
        "query_validate": {
          "combinator": "and",
          "rules": [
            ...
            {
              "id": "f25cc84c-8862-4587-b43c-2d997ab83251",
              "field": "data",
              "operator": "=",
              "valueSource": "value",
              "value": "67da3303ff9b2c7f1959f964"
      ...
      },
      {
        ...
        "response": {
          "_id": "67da2914ff9b2c7f1959f10e",
          "title": "approve tweet vote",
          "entity": "mge-tweet-social-votes",
          "path_file": "json/response/67da2914ff9b2c7f1959f10e.json"
        },
        "query_validate": {
          "combinator": "and",
          "rules": [
            ...
            {
              "id": "eb6e3e41-6404-4410-9ccf-0f259ddee9d4",
              "field": "data",
              "operator": "=",
              "valueSource": "value",
              "value": "67da3303ff9b2c7f1959f964"
