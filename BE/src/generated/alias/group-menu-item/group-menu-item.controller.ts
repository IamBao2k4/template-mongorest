...
import { CustomGroupMenuItemService } from '../../customs/group-menu-item/Customgroup-menu-item.service';

export class GroupMenuItemController {
  private service: CustomGroupMenuItemService;

  constructor() {
    this.service = new CustomGroupMenuItemService();
  }
