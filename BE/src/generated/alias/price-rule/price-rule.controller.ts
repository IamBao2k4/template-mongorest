...
import { CustomPriceRuleService } from '../../customs/price-rule/Customprice-rule.service';

export class PriceRuleController {
  private service: CustomPriceRuleService;

  constructor() {
    this.service = new CustomPriceRuleService();
  }
