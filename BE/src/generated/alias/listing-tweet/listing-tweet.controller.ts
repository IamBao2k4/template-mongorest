...
import { CustomListingTweetService } from '../../customs/listing-tweet/Customlisting-tweet.service';

export class ListingTweetController {
  private service: CustomListingTweetService;

  constructor() {
    this.service = new CustomListingTweetService();
  }
