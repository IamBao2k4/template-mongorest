...
export class ListingTweetService {
    ...
    "validate": [
      {
        ...
        "custom_filter": {
          "id": "cd356707-a7da-4d5b-8bbe-a27ac17907a6",
          "rules": [
            {
              "id": "3bdf8198-9413-4f62-8e2f-fe7d66a24bd2",
              "field": "@param:type",
              "operator": "=",
              "valueSource": "value",
              "value": "posts"
      ...
      },
      {
        ...
        "custom_filter": {
          "id": "00f0a134-5877-4f1b-938f-e7ff1c8c0173",
          "rules": [
            {
              "id": "85af6fc0-333e-485f-824f-c0ac312d58cf",
              "field": "@param:type",
              "operator": "=",
              "valueSource": "value",
              "value": "news"
