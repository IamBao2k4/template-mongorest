...
export class GroupsManagingService {
    ...
    "validate": [
      {
        ...
        "response": {
          ...
          "path_file": "json/response/6763c55f0ac6cdefe65cdc83.json"
        },
        "query_validate": {
          "combinator": "and",
          "rules": [
            {
              "id": "13adb190-ffd5-4060-bc03-666d67ead673",
              "field": "data",
              "operator": "=",
              "valueSource": "value",
          ...
          "id": "47e4e2ad-c0a5-4090-bedf-74dd7e12ff4f"
        },
        "list_validate": [
          {
