...
import { CustomGroupReportsService } from '../../customs/group-reports/Customgroup-reports.service';

export class GroupReportsController {
  private service: CustomGroupReportsService;

  constructor() {
    this.service = new CustomGroupReportsService();
  }
