...
export class UserTweetSavedService {
    ...
    "validate": [
      {
        ...
        "response": {
          ...
          "entity": "mge-tweet",
          "path_file": "json/response/6784ef448145c207b78a993e.json"
        },
        "query_validate": {
          "combinator": "and",
          "rules": [
            {
              "id": "c5b9ec95-a5da-49d9-ae4f-c5bcab473d9f",
              "field": "data",
              "operator": "=",
              "valueSource": "value",
          ...
          "id": "8404a01c-015d-4628-85ac-545e52563645"
        },
        "list_validate": [
          {
