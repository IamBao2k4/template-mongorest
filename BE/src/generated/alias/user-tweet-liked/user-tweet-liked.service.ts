...
export class UserTweetLikedService {
    ...
    "validate": [
      {
        ...
        "response": {
          ...
          "entity": "mge-group",
          "path_file": "json/response/6784ada78145c207b78a9279.json"
        },
        "query_validate": {
          "combinator": "and",
          "rules": [
            {
              "id": "5eb4174d-89ef-41c5-819b-78f790bba47c",
              "field": "data",
              "operator": "=",
              "valueSource": "value",
          ...
          "id": "0567aa7e-d8b2-409a-b192-db66e1572609"
        },
        "list_validate": [
          {
