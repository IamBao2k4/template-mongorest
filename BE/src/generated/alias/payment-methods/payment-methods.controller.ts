...
import { CustomPaymentMethodsService } from '../../customs/payment-methods/Custompayment-methods.service';

export class PaymentMethodsController {
  private service: CustomPaymentMethodsService;

  constructor() {
    this.service = new CustomPaymentMethodsService();
  }
