...
import { CustomTweetSavedService } from '../../customs/tweet-saved/Customtweet-saved.service';

export class TweetSavedController {
  private service: CustomTweetSavedService;

  constructor() {
    this.service = new CustomTweetSavedService();
  }
