...
import { CustomGroupCategoriesService } from '../../customs/group-categories/Customgroup-categories.service';

export class GroupCategoriesController {
  private service: CustomGroupCategoriesService;

  constructor() {
    this.service = new CustomGroupCategoriesService();
  }
