...
import { CustomShippingMethodsService } from '../../customs/shipping-methods/Customshipping-methods.service';

export class ShippingMethodsController {
  private service: CustomShippingMethodsService;

  constructor() {
    this.service = new CustomShippingMethodsService();
  }
