...
import { CustomDiscussionService } from '../../customs/discussion/Customdiscussion.service';

export class DiscussionController {
  private service: CustomDiscussionService;

  constructor() {
    this.service = new CustomDiscussionService();
  }
