...
import { CustomLearningPathService } from '../../customs/learning-path/Customlearning-path.service';

export class LearningPathController {
  private service: CustomLearningPathService;

  constructor() {
    this.service = new CustomLearningPathService();
  }
